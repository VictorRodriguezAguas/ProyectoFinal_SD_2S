...
export class ConfigurationComponent implements OnInit {
  ...
  validarPerfil(){
    ...
    if(usuario.emprendedor == 1){
      this.headerBackgroundColor = 'background-img-6';
      document.querySelector('body').classList.add('background-img-6');
    }
    if(usuario.asistencia_tecnica == 1){
      this.headerBackgroundColor = 'background-grd-dark';
      document.querySelector('body').classList.add('background-img-6');
      document.querySelector('.pcoded-navbar').classList.remove("menu-light");
    }
    if(usuario.mentor == 1) {
    ...
    if(usuario.administrador == 1) {
      this.headerBackgroundColor = 'background-grd-dark';
      document.querySelector('body').classList.add('background-grd-dark');
      document.querySelector('.pcoded-navbar').classList.remove("menu-light");
    }
