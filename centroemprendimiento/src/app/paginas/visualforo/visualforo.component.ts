...
@Component({
  selector: 'app-visualforo',
  templateUrl: './visualforo.component.html',
  styleUrls: ['./visualforo.component.scss']
})
export class VisualforoComponent implements OnInit, OnDestroy {
  public future: Date;
