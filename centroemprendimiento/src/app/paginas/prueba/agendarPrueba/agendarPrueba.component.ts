...
@Component({
  selector: 'app-agendarPrueba',
  templateUrl: './agendarPrueba.component.html',
  styleUrls: ['./agendarPrueba.component.scss']
})
export class AgendarPruebaComponent implements OnInit {
