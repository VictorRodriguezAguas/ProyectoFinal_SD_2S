...
export class PruebaComponent implements OnInit {
  ...
  ngAfterViewInit() {
    this.programaService.getAsistenteTecnicoAsignado(0).subscribe(data => {
      if (data.codigo) {
  ...
  cargarDisponibilidad(data) {
    ...
    var evento: EventInput = {
      ...
      start: '2020-12-15T08:00:00',
      end: '2020-12-15T11:30:00',
    ...
    var evento: EventInput = {
      id:"id2",
      groupId: 'disponibleID',
      start: '2020-12-15T12:00:00',
      end: '2020-12-15T11:13:00:00',
      rendering: 'background',
      backgroundColor: '#4dd636', // #8fdf82
      is_new: false,
      stick: true
    ...
    var evento: EventInput = {
      id:"id3",
      groupId: 'disponibleID',
      start: '2020-12-15T15:00:00',
      end: '2020-12-15T16:30:00',
      rendering: 'background',
      backgroundColor: '#4dd636', // #8fdf82
      is_new: false,
      stick: true
    ...
    var evento: EventInput = {
      id:"id4",
      groupId: 'disponibleID',
      start: '2020-12-16T08:30:00',
      end: '2020-12-16T10:30:00',
      rendering: 'background',
      backgroundColor: '#4dd636', // #8fdf82
      is_new: false,
      stick: true
    ...
    var evento: EventInput = {
      id:"id5",
      groupId: 'disponibleID',
      start: '2020-12-16T12:00:00',
      end: '2020-12-16T11:14:00:00',
      rendering: 'background',
      backgroundColor: '#4dd636', // #8fdf82
      is_new: false,
      stick: true
