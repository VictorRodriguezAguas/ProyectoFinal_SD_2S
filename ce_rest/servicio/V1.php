...
$app->group('/v1', function () use ($app) {
    ...
    $app->post('/asistentetecnico/agenda/configs', function (Request $request, Response $response, array $args) {
        require_once("../util/URL.php");
        require_once '../util/General.php';
        require_once("../bo/ReunionBO.php");
        $post = $request->getBody();
        $reunionBO = new ReunionBO();
        $data = $reunionBO->getMeetingConfigs();
    ...
    $app->post('/usuario/insertar', function (Request $request, Response $response, array $args) {
        require_once("../util/URL.php");
        require_once '../util/General.php';
        require_once("../bo/UsuarioBO.php");
        $usuarioBO = new UsuarioBO();
        $data = $usuarioBO->insertarUsuario();
        return json_encode($data);
    });
});
