...
$tabla="reunion";
$campos=array("id_agenda","hora_inicio_agenda","hora_fin_agendad","fecha_agendada","hora_inicio","hora_fin","temas","acuerdos","observacion","estado");
$tipodatos=array("i","s","s","s","s","s","s","s","s","s");
$valores=array($reunion->id_agenda,$reunion->hora_inicio_agenda,$reunion->hora_fin_agendad,$reunion->fecha_agendada,
			   $reunion->hora_inicio_reunion,$reunion->hora_fin_reunion,$reunion->temas,$reunion->acuerdos,$reunion->observacion,$reunion->estado);
